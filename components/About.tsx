    ...
    <section className="py-16 md:py-24 bg-void">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            <h2 className="text-xs md:text-sm font-bold text-electric tracking-[0.2em] uppercase">{t.about.subtitle}</h2>
            <h3 className="text-3xl md:text-4xl font-extrabold text-white">{t.about.title}</h3>
            ...
            <div className="grid grid-cols-3 gap-3 md:gap-4 pt-4 md:pt-6">
              <div className="text-center p-3 md:p-4 rounded-lg bg-anthracite border border-steel hover:border-electric transition-colors group">
                ...
                <span className="font-semibold text-white block text-xs md:text-sm">{t.about.item1}</span>
              </div>
              <div className="text-center p-3 md:p-4 rounded-lg bg-anthracite border border-steel hover:border-electric transition-colors group">
                <PenTool className="w-6 h-6 md:w-8 md:h-8 text-chrome group-hover:text-electric mx-auto mb-2 transition-colors" />
                <span className="font-semibold text-white block text-xs md:text-sm">{t.about.item2}</span>
              </div>
              <div className="text-center p-3 md:p-4 rounded-lg bg-anthracite border border-steel hover:border-electric transition-colors group">
                <Coffee className="w-6 h-6 md:w-8 md:h-8 text-chrome group-hover:text-electric mx-auto mb-2 transition-colors" />
                <span className="font-semibold text-white block text-xs md:text-sm">{t.about.item3}</span>
              </div>
            </div>
          </motion.div>
