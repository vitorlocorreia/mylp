    ...
    <section id="capabilities" className="py-16 md:py-24 bg-void relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-12 md:mb-16 max-w-3xl mx-auto">
          <h2 className="text-xs md:text-sm font-bold text-electric tracking-[0.2em] uppercase mb-3">{t.capabilities.subtitle}</h2>
          <h3 className="text-3xl md:text-5xl font-extrabold text-white leading-tight">
            {t.capabilities.title} <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-electric to-white">{t.capabilities.titleHighlight}</span>
          </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 auto-rows-[minmax(180px,auto)]">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h4 className="text-2xl md:text-3xl font-bold text-white mb-4">{t.capabilities.card1.title}</h4>
              <p className="text-chrome text-base md:text-lg leading-relaxed max-w-lg">
                {t.capabilities.card1.description}
              </p>
            </div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3 text-sm font-medium text-white/80">
              <div className="flex items-center gap-2 px-3 py-1 bg-void rounded border border-steel">
                <ShieldCheck size={14} className="text-electric" /> {t.capabilities.card1.tag1}
              </div>
              <div className="flex items-center gap-2 px-3 py-1 bg-void rounded border border-steel">
                <TrendingUp size={14} className="text-electric" /> {t.capabilities.card1.tag2}
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <h4 className="text-xl font-bold text-white mb-2">{t.capabilities.card2.title}</h4>
            <p className="text-chrome text-sm">
              {t.capabilities.card2.description}
            </p>
          </motion.div>
          ...
          >
            ...
            <h4 className="text-xl font-bold text-white mb-2">{t.capabilities.card3.title}</h4>
            <p className="text-chrome text-sm">
              {t.capabilities.card3.description}
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start md:items-center relative z-10">
              ...
              <div>
                <h4 className="text-xl font-bold text-white">{t.capabilities.card4.title}</h4>
                <p className="text-chrome max-w-xl text-sm mt-1">
                  {t.capabilities.card4.description}
                </p>
              </div>
            </div>
            ...
            <div className="relative z-10 flex gap-4 w-full md:w-auto">
              <div className="flex-1 md:flex-none text-center px-4 py-2 bg-void rounded border border-steel">
                ...
                <span className="text-[10px] text-gray-500 uppercase tracking-wider">{t.capabilities.card4.stat1Config}</span>
              </div>
              <div className="flex-1 md:flex-none text-center px-4 py-2 bg-void rounded border border-steel">
                <span className="block text-xl font-bold text-white">100<span className="text-electric text-sm">%</span></span>
                <span className="text-[10px] text-gray-500 uppercase tracking-wider">{t.capabilities.card4.stat2Config}</span>
              </div>
            </div>
          </motion.div>
